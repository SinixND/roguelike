...
(function() {if(Module["ENVIRONMENT_IS_PTHREAD"]||Module["$ww"])return;var loadPackage=function(metadata){var PACKAGE_PATH="";if(typeof window==="object"){PACKAGE_PATH=window["encodeURIComponent"](window.location.pathname.toString().substring(0,window.location.pathname.toString().lastIndexOf("/"))+"/")}else if(typeof process==="undefined"&&typeof location!=="undefined"){PACKAGE_PATH=encodeURIComponent(location.pathname.toString().substring(0,location.pathname.toString().lastIndexOf("/"))+"/")}var PACKAGE_NAME="web/main.data";var REMOTE_PACKAGE_BASE="main.data";if(typeof Module["locateFilePackage"]==="function"&&!Module["locateFile"]){Module["locateFile"]=Module["locateFilePackage"];err("warning: you defined Module.locateFilePackage, that has been renamed to Module.locateFile (using your locateFilePackage for now)")}var REMOTE_PACKAGE_NAME=Module["locateFile"]?Module["locateFile"](REMOTE_PACKAGE_BASE,""):REMOTE_PACKAGE_BASE;var REMOTE_PACKAGE_SIZE=metadata["remote_package_size"];function fetchRemotePackage(packageName,packageSize,callback,errback){if(typeof process==="object"&&typeof process.versions==="object"&&typeof process.versions.node==="string"){require("fs").readFile(packageName,function(err,contents){if(err){errback(err)}else{callback(contents.buffer)}});return}var xhr=new XMLHttpRequest;xhr.open("GET",packageName,true);xhr.responseType="arraybuffer";xhr.onprogress=function(event){var url=packageName;var size=packageSize;if(event.total)size=event.total;if(event.loaded){if(!xhr.addedTotal){xhr.addedTotal=true;if(!Module.dataFileDownloads)Module.dataFileDownloads={};Module.dataFileDownloads[url]={loaded:event.loaded,total:size}}else{Module.dataFileDownloads[url].loaded=event.loaded}var total=0;var loaded=0;var num=0;for(var download in Module.dataFileDownloads){var data=Module.dataFileDownloads[download];total+=data.total;loaded+=data.loaded;num++}total=Math.ceil(total*Module.expectedDataFileDownloads/num);if(Module["setStatus"])Module["setStatus"](`Downloading data... (${loaded}/${total})`)}else if(!Module.dataFileDownloads){if(Module["setStatus"])Module["setStatus"]("Downloading data...")}};xhr.onerror=function(event){throw new Error("NetworkError for: "+packageName)};xhr.onload=function(event){if(xhr.status==200||xhr.status==304||xhr.status==206||xhr.status==0&&xhr.response){var packageData=xhr.response;callback(packageData)}else{throw new Error(xhr.statusText+" : "+xhr.responseURL)}};xhr.send(null)}function handleError(error){console.error("package error:",error)}var fetchedCallback=null;var fetched=Module["getPreloadedPackage"]?Module["getPreloadedPackage"](REMOTE_PACKAGE_NAME,REMOTE_PACKAGE_SIZE):null;if(!fetched)fetchRemotePackage(REMOTE_PACKAGE_NAME,REMOTE_PACKAGE_SIZE,function(data){if(fetchedCallback){fetchedCallback(data);fetchedCallback=null}else{fetched=data}},handleError);function runWithFS(){function assert(check,msg){if(!check)throw msg+(new Error).stack}Module["FS_createPath"]("/","resources",true,true);Module["FS_createPath"]("/resources","favicon",true,true);Module["FS_createPath"]("/resources","fonts",true,true);Module["FS_createPath"]("/resources","iconset",true,true);Module["FS_createPath"]("/resources","textures",true,true);function DataRequest(start,end,audio){this.start=start;this.end=end;this.audio=audio}DataRequest.prototype={requests:{},open:function(mode,name){this.name=name;this.requests[name]=this;Module["addRunDependency"](`fp ${this.name}`)},send:function(){},onload:function(){var byteArray=this.byteArray.subarray(this.start,this.end);this.finish(byteArray)},finish:function(byteArray){var that=this;Module["FS_createDataFile"](this.name,null,byteArray,true,true,true);Module["removeRunDependency"](`fp ${that.name}`);this.requests[this.name]=null}};var files=metadata["files"];for(var i=0;i<files.length;++i){new DataRequest(files[i]["start"],files[i]["end"],files[i]["audio"]||0).open("GET",files[i]["filename"])}function processPackageData(arrayBuffer){assert(arrayBuffer,"Loading data file failed.");assert(arrayBuffer.constructor.name===ArrayBuffer.name,"bad input to processPackageData");var byteArray=new Uint8Array(arrayBuffer);DataRequest.prototype.byteArray=byteArray;var files=metadata["files"];for(var i=0;i<files.length;++i){DataRequest.prototype.requests[files[i].filename].onload()}Module["removeRunDependency"]("datafile_web/main.data")}Module["addRunDependency"]("datafile_web/main.data");if(!Module.preloadResults)Module.preloadResults={};Module.preloadResults[PACKAGE_NAME]={fromCache:false};if(fetched){processPackageData(fetched);fetched=null}else{fetchedCallback=processPackageData}}if(Module["calledRun"]){runWithFS()}else{if(!Module["preRun"])Module["preRun"]=[];Module["preRun"].push(runWithFS)}};loadPackage({"files":[{"filename":"/resources/favicon/favicon.ico","start":0,"end":318},{"filename":"/resources/favicon/favicon.png","start":318,"end":1885},{"filename":"/resources/fonts/JuliaMono-RegularLatin.ttf","start":1885,"end":72477},{"filename":"/resources/iconset/iconset.rgi","start":72477,"end":88873},{"filename":"/resources/iconset/iconset.rgi.h","start":88873,"end":127727},{"filename":"/resources/iconset/iconset.rgi.png","start":127727,"end":137819},{"filename":"/resources/textures/Cursor.png","start":137819,"end":148849},{"filename":"/resources/textures/Empty.png","start":148849,"end":155993},{"filename":"/resources/textures/Hero.png","start":155993,"end":167987},{"filename":"/resources/textures/TileAttackable.png","start":167987,"end":180087},{"filename":"/resources/textures/TileFloor.png","start":180087,"end":191206},{"filename":"/resources/textures/TilePath.png","start":191206,"end":200347},{"filename":"/resources/textures/TileReachable.png","start":200347,"end":212093},{"filename":"/resources/textures/TileSupportable.png","start":212093,"end":224725},{"filename":"/resources/textures/TileWall.png","start":224725,"end":235697},{"filename":"/resources/textures/template.png","start":235697,"end":246663}],"remote_package_size":246663}) })();
...
if (ENVIRONMENT_IS_NODE) {
    ...
    readAsync = (filename, onload, onerror, binary = true) => {filename=isFileURI(filename)?new URL(filename):nodePath.normalize(filename);fs.readFile(filename,binary?undefined:"utf8",(err,data)=>{if(err)onerror(err);else onload(binary?data.buffer:data)}) };
    ...
    process.on("uncaughtException", ex => {if(ex!=="unwind"&&!(ex instanceof ExitStatus)&&!(ex.context instanceof ExitStatus)){throw ex} });
    ...
    }
    {
        ...
        readAsync = (url, onload, onerror) => {var xhr=new XMLHttpRequest;xhr.open("GET",url,true);xhr.responseType="arraybuffer";xhr.onload=()=>{if(xhr.status==200||xhr.status==0&&xhr.response){onload(xhr.response);return}onerror()};xhr.onerror=onerror;xhr.send(null) }
    }
} else {
}
...
function getBinaryPromise(binaryFile) {
    if (!wasmBinary && (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER)) {
        if (typeof fetch == "function" && !isFileURI(binaryFile)) {
            return fetch(binaryFile, {credentials : "same-origin"}).then(response => {if(!response["ok"]){throw`failed to load wasm binary file at '${binaryFile}'`}return response["arrayBuffer"]() }).catch(() => getBinarySync(binaryFile))
        } else if (readAsync) {
...
function instantiateArrayBuffer(binaryFile, imports, receiver) {
    return getBinaryPromise(binaryFile).then(binary => WebAssembly.instantiate(binary, imports)).then(receiver, reason => {err(`failed to asynchronously prepare wasm: ${reason}`);abort(reason) })
}
...
var tempDouble;
var tempI64;
var ASM_CONSTS = {35488 : () => {if(document.fullscreenElement)return 1 }, 35534 : () => document.getElementById("canvas").width, 35586 : () => parseInt(document.getElementById("canvas").style.width), 35654 : () => {document.exitFullscreen()}, 35681 : () => {setTimeout(function() { Module.requestFullscreen(false, false) }, 100)}, 35754 : () => {if(document.fullscreenElement)return 1 }, 35800 : () => document.getElementById("canvas").width, 35852 : () => screen.width, 35877 : () => {document.exitFullscreen()}, 35904 : () => {setTimeout(function() {Module.requestFullscreen(false,true);setTimeout(function(){canvas.style.width="unset"},100) }, 100)}, 36037 : () => {if(document.fullscreenElement)return 1 }, 36083 : () => document.getElementById("canvas").width, 36135 : () => parseInt(document.getElementById("canvas").style.width), 36203 : () => {if(document.fullscreenElement)return 1 }, 36249 : () => document.getElementById("canvas").width, 36301 : () => screen.width, 36326 : () => {if(document.fullscreenElement)return 1 }, 36372 : () => document.getElementById("canvas").width, 36424 : () => screen.width, 36449 : () => {document.exitFullscreen()}, 36476 : () => {if(document.fullscreenElement)return 1 }, 36522 : () => document.getElementById("canvas").width, 36574 : () => parseInt(document.getElementById("canvas").style.width), 36642 : () => {document.exitFullscreen()}, 36669 : () => screen.width, 36694 : () => screen.height, 36720 : () => window.screenX, 36747 : () => window.screenY, 36774 : $0 => {navigator.clipboard.writeText(UTF8ToString($0))}, 36827 : $0 => {document.getElementById("canvas").style.cursor = UTF8ToString($0)}, 36898 : () => {document.getElementById("canvas").style.cursor = "none"}, 36955 : $0 => {document.getElementById("canvas").style.cursor = UTF8ToString($0)}, 37026 : () => {if(document.fullscreenElement)return 1 }, 37072 : () => {if(document.pointerLockElement)return 1 }};
...
var asyncLoad = (url, onload, onerror, noRunDep) => {var dep=!noRunDep?getUniqueRunDependency(`al ${url}`):"";readAsync(url,arrayBuffer=>{onload(new Uint8Array(arrayBuffer));if(dep)removeRunDependency(dep)},event=>{if(onerror){onerror()}else{throw`Loading data file "${url}" failed.`}});if(dep)addRunDependency(dep) };
...
var FS_handledByPreloadPlugin = (byteArray, fullname, finish, onerror) => {if(typeof Browser!="undefined")Browser.init();var handled=false;preloadPlugins.forEach(plugin=>{if(handled)return;if(plugin["canHandle"](fullname)){plugin["handle"](byteArray,fullname,finish,onerror);handled=true}});return handled };
...
var readEmAsmArgs = (sigPtr, buf) => {readEmAsmArgsArray.length=0;var ch;while(ch=HEAPU8[sigPtr++]){var wide=ch!=105;wide&=ch!=112;buf+=wide&&buf%8?4:0;readEmAsmArgsArray.push(ch==112?HEAPU32[buf>>2]:ch==105?HEAP32[buf>>2]:HEAPF64[buf>>3]);buf+=wide?8:4}return readEmAsmArgsArray };
...
var _emscripten_get_gamepad_status = (index, gamepadState) => {if(index<0||index>=JSEvents.lastGamepadState.length)return-5;if(!JSEvents.lastGamepadState[index])return-7;fillGamepadEventData(gamepadState,JSEvents.lastGamepadState[index]);return 0 };
...
var _emscripten_sample_gamepad_data = () => {try{if(navigator.getGamepads)return(JSEvents.lastGamepadState=navigator.getGamepads())?0:-1}catch(e){navigator.getGamepads=null}return-1 };
...
var doWritev = (stream, iov, iovcnt, offset) => {var ret=0;for(var i=0;i<iovcnt;i++){var ptr=HEAPU32[iov>>2];var len=HEAPU32[iov+4>>2];iov+=8;var curr=FS.write(stream,HEAP8,ptr,len,offset);if(curr<0)return-1;ret+=curr;if(typeof offset!=="undefined"){offset+=curr}}return ret };
...
var webgl_enable_OES_vertex_array_object = ctx => {var ext=ctx.getExtension("OES_vertex_array_object");if(ext){ctx["createVertexArray"]=()=>ext["createVertexArrayOES"]();ctx["deleteVertexArray"]=vao=>ext["deleteVertexArrayOES"](vao);ctx["bindVertexArray"]=vao=>ext["bindVertexArrayOES"](vao);ctx["isVertexArray"]=vao=>ext["isVertexArrayOES"](vao);return 1} };
var webgl_enable_WEBGL_draw_buffers = ctx => {var ext=ctx.getExtension("WEBGL_draw_buffers");if(ext){ctx["drawBuffers"]=(n,bufs)=>ext["drawBuffersWEBGL"](n,bufs);return 1} };
...
var _glBindBuffer = (target, buffer) => { GLctx.bindBuffer(target, GL.buffers[buffer]) };
var _glBindTexture = (target, texture) => { GLctx.bindTexture(target, GL.textures[texture]) };
var _glBlendFunc = (x0, x1) => GLctx.blendFunc(x0, x1);
var _glBufferData = (target, size, data, usage) => { GLctx.bufferData(target, data ? HEAPU8.subarray(data, data + size) : size, usage) };
var _glBufferSubData = (target, offset, size, data) => { GLctx.bufferSubData(target, offset, HEAPU8.subarray(data, data + size)) };
var _glClear = x0 => GLctx.clear(x0);
var _glClearColor = (x0, x1, x2, x3) => GLctx.clearColor(x0, x1, x2, x3);
var _glClearDepthf = x0 => GLctx.clearDepth(x0);
var _glCompileShader = shader => { GLctx.compileShader(GL.shaders[shader]) };
var _glCompressedTexImage2D = (target, level, internalFormat, width, height, border, imageSize, data) => { GLctx.compressedTexImage2D(target, level, internalFormat, width, height, border, data ? HEAPU8.subarray(data, data + imageSize) : null) };
...
var _glDeleteBuffers = (n, buffers) => {for(var i=0;i<n;i++){var id=HEAP32[buffers+i*4>>2];var buffer=GL.buffers[id];if(!buffer)continue;GLctx.deleteBuffer(buffer);buffer.name=0;GL.buffers[id]=null} };
var _glDeleteProgram = id => {if(!id)return;var program=GL.programs[id];if(!program){GL.recordError(1281);return}GLctx.deleteProgram(program);program.name=0;GL.programs[id]=null };
var _glDeleteShader = id => {if(!id)return;var shader=GL.shaders[id];if(!shader){GL.recordError(1281);return}GLctx.deleteShader(shader);GL.shaders[id]=null };
var _glDeleteTextures = (n, textures) => {for(var i=0;i<n;i++){var id=HEAP32[textures+i*4>>2];var texture=GL.textures[id];if(!texture)continue;GLctx.deleteTexture(texture);texture.name=0;GL.textures[id]=null} };
...
var _glGetShaderInfoLog = (shader, maxLength, length, infoLog) => {var log=GLctx.getShaderInfoLog(GL.shaders[shader]);if(log===null)log="(unknown error)";var numBytesWrittenExclNull=maxLength>0&&infoLog?stringToUTF8(log,infoLog,maxLength):0;if(length)HEAP32[length>>2]=numBytesWrittenExclNull };
...
var _glGetUniformLocation = (program, name) => {name=UTF8ToString(name);if(program=GL.programs[program]){webglPrepareUniformLocationsBeforeFirstUse(program);var uniformLocsById=program.uniformLocsById;var arrayIndex=0;var uniformBaseName=name;var leftBrace=webglGetLeftBracePos(name);if(leftBrace>0){arrayIndex=jstoi_q(name.slice(leftBrace+1))>>>0;uniformBaseName=name.slice(0,leftBrace)}var sizeAndId=program.uniformSizeAndIdsByName[uniformBaseName];if(sizeAndId&&arrayIndex<sizeAndId[0]){arrayIndex+=sizeAndId[1];if(uniformLocsById[arrayIndex]=uniformLocsById[arrayIndex]||GLctx.getUniformLocation(program,name)){return arrayIndex}}}else{GL.recordError(1281)}return-1 };
...
var _glPixelStorei = (pname, param) => {if(pname==3317){GL.unpackAlignment=param}GLctx.pixelStorei(pname,param) };
var computeUnpackAlignedImageSize = (width, height, sizePerPixel, alignment) => {function roundedToNextMultipleOf(x,y){return x+y-1&-y}var plainRowSize=width*sizePerPixel;var alignedRowSize=roundedToNextMultipleOf(plainRowSize,alignment);return height*alignedRowSize };
var colorChannelsInGlTextureFormat = format => {var colorChannels={5:3,6:4,8:2,29502:3,29504:4};return colorChannels[format-6402]||1 };
var heapObjectForWebGLType = type => {type-=5120;if(type==1)return HEAPU8;if(type==4)return HEAP32;if(type==6)return HEAPF32;if(type==5||type==28922)return HEAPU32;return HEAPU16 };
...
var _glReadPixels = (x, y, width, height, format, type, pixels) => {var pixelData=emscriptenWebGLGetTexPixelData(type,format,width,height,pixels,format);if(!pixelData){GL.recordError(1280);return}GLctx.readPixels(x,y,width,height,format,type,pixelData) };
...
var _glTexImage2D = (target, level, internalFormat, width, height, border, format, type, pixels) => { GLctx.texImage2D(target, level, internalFormat, width, height, border, format, type, pixels ? emscriptenWebGLGetTexPixelData(type, format, width, height, pixels, internalFormat) : null) };
...
var wasmImports = {za : GetWindowInnerHeight, Aa : GetWindowInnerWidth, a : ___assert_fail, w : ___cxa_throw, Q : ___syscall_faccessat, N : ___syscall_fcntl64, Za : ___syscall_getcwd, $a : ___syscall_ioctl, ab : ___syscall_openat, bb : __emscripten_get_now_is_monotonic, u : _abort, i : _emscripten_asm_const_int, O : _emscripten_date_now, T : _emscripten_get_element_css_size, ta : _emscripten_get_gamepad_status, v : _emscripten_get_now, ua : _emscripten_get_num_gamepads, P : _emscripten_memcpy_js, Ya : _emscripten_resize_heap, va : _emscripten_sample_gamepad_data, ya : _emscripten_set_canvas_element_size, ba : _emscripten_set_click_callback_on_thread, da : _emscripten_set_fullscreenchange_callback_on_thread, W : _emscripten_set_gamepadconnected_callback_on_thread, V : _emscripten_set_gamepaddisconnected_callback_on_thread, db : _emscripten_set_main_loop, aa : _emscripten_set_pointerlockchange_callback_on_thread, ca : _emscripten_set_resize_callback_on_thread, Y : _emscripten_set_touchcancel_callback_on_thread, _ : _emscripten_set_touchend_callback_on_thread, Z : _emscripten_set_touchmove_callback_on_thread, $ : _emscripten_set_touchstart_callback_on_thread, Ba : _emscripten_set_window_title, R : _exit, x : _fd_close, _a : _fd_read, Wa : _fd_seek, M : _fd_write, Xa : _getentropy, L : _glActiveTexture, C : _glAttachShader, j : _glBindAttribLocation, c : _glBindBuffer, e : _glBindTexture, Ra : _glBlendFunc, m : _glBufferData, p : _glBufferSubData, I : _glClear, J : _glClearColor, Oa : _glClearDepthf, Ga : _glCompileShader, Ka : _glCompressedTexImage2D, Ea : _glCreateProgram, Ia : _glCreateShader, Sa : _glCullFace, k : _glDeleteBuffers, F : _glDeleteProgram, G : _glDeleteShader, E : _glDeleteTextures, Qa : _glDepthFunc, H : _glDetachShader, Ta : _glDisable, l : _glDisableVertexAttribArray, Va : _glDrawArrays, Ua : _glDrawElements, K : _glEnable, g : _glEnableVertexAttribArray, Pa : _glFrontFace, n : _glGenBuffers, Ma : _glGenTextures, r : _glGetAttribLocation, Ca : _glGetProgramInfoLog, B : _glGetProgramiv, Fa : _glGetShaderInfoLog, D : _glGetShaderiv, q : _glGetUniformLocation, Da : _glLinkProgram, Na : _glPixelStorei, Ja : _glReadPixels, Ha : _glShaderSource, La : _glTexImage2D, t : _glTexParameterf, f : _glTexParameteri, cb : _glUniform1i, X : _glUniform4f, wa : _glUniformMatrix4fv, o : _glUseProgram, h : _glVertexAttribPointer, s : _glViewport, z : _glfwCreateWindow, qa : _glfwDefaultWindowHints, S : _glfwDestroyWindow, A : _glfwGetPrimaryMonitor, b : _glfwGetTime, pa : _glfwGetVideoModes, ra : _glfwInit, ea : _glfwMakeContextCurrent, ja : _glfwSetCharCallback, fa : _glfwSetCursorEnterCallback, ha : _glfwSetCursorPosCallback, la : _glfwSetDropCallback, sa : _glfwSetErrorCallback, ka : _glfwSetKeyCallback, ia : _glfwSetMouseButtonCallback, ga : _glfwSetScrollCallback, ma : _glfwSetWindowFocusCallback, na : _glfwSetWindowIconifyCallback, U : _glfwSetWindowShouldClose, oa : _glfwSetWindowSizeCallback, xa : _glfwSwapBuffers, y : _glfwTerminate, d : _glfwWindowHint};
...
var _main = Module["_main"] = (a0, a1) => (_main = Module["_main"] = wasmExports["jb"])(a0, a1);
var ___cxa_is_pointer_type = a0 => (___cxa_is_pointer_type = wasmExports["kb"])(a0);
var ___start_em_js = Module["___start_em_js"] = 37119;
var ___stop_em_js = Module["___stop_em_js"] = 37192;

...
// Rotation matrices
const Matrix2x2i M_ROTATE_NONE{1, 0, 0, 1};
const Matrix2x2i M_ROTATE_CW{0, -1, 1, 0};
const Matrix2x2i M_ROTATE_CCW{0, 1, -1, 0};
const Matrix2x2 M_ROTATE_CW_45{0.7071068, -0.7071068, 0.7071068, 0.7071068};
...
// Edge pan
const float PAN_TICK{0.1f}; // time in seconds to next pan progress

...
// end include: /tmp/tmpgt9ijc03.js
...
var ASM_CONSTS = {
  183692: () => { if (document.fullscreenElement) return 1; },  
 183738: () => { return document.getElementById('canvas').width; },  
 183790: () => { return parseInt(document.getElementById('canvas').style.width); },  
 183858: () => { document.exitFullscreen(); },  
 183885: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 183958: () => { if (document.fullscreenElement) return 1; },  
 184004: () => { return document.getElementById('canvas').width; },  
 184056: () => { return screen.width; },  
 184081: () => { document.exitFullscreen(); },  
 184108: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 184241: () => { return window.innerWidth; },  
 184267: () => { return window.innerHeight; },  
 184294: () => { if (document.fullscreenElement) return 1; },  
 184340: () => { return document.getElementById('canvas').width; },  
 184392: () => { return parseInt(document.getElementById('canvas').style.width); },  
 184460: () => { if (document.fullscreenElement) return 1; },  
 184506: () => { return document.getElementById('canvas').width; },  
 184558: () => { return screen.width; },  
 184583: () => { return window.innerWidth; },  
 184609: () => { return window.innerHeight; },  
 184636: () => { if (document.fullscreenElement) return 1; },  
 184682: () => { return document.getElementById('canvas').width; },  
 184734: () => { return screen.width; },  
 184759: () => { document.exitFullscreen(); },  
 184786: () => { if (document.fullscreenElement) return 1; },  
 184832: () => { return document.getElementById('canvas').width; },  
 184884: () => { return parseInt(document.getElementById('canvas').style.width); },  
 184952: () => { document.exitFullscreen(); },  
 184979: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 185037: () => { return screen.width; },  
 185062: () => { return screen.height; },  
 185088: () => { return window.screenX; },  
 185115: () => { return window.screenY; },  
 185142: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 185195: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 185266: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 185323: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 185579: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 185650: () => { if (document.fullscreenElement) return 1; },  
 185696: () => { return window.innerWidth; },  
 185722: () => { return window.innerHeight; },  
 185749: () => { if (document.pointerLockElement) return 1; }
};

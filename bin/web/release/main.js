...
// end include: /tmp/tmpgicqdkjd.js
...
var ASM_CONSTS = {
  36896: () => { if (document.fullscreenElement) return 1; },  
 36942: () => { return document.getElementById('canvas').width; },  
 36994: () => { return parseInt(document.getElementById('canvas').style.width); },  
 37062: () => { document.exitFullscreen(); },  
 37089: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 37162: () => { if (document.fullscreenElement) return 1; },  
 37208: () => { return document.getElementById('canvas').width; },  
 37260: () => { return screen.width; },  
 37285: () => { document.exitFullscreen(); },  
 37312: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 37445: () => { return window.innerWidth; },  
 37471: () => { return window.innerHeight; },  
 37498: () => { if (document.fullscreenElement) return 1; },  
 37544: () => { return document.getElementById('canvas').width; },  
 37596: () => { return parseInt(document.getElementById('canvas').style.width); },  
 37664: () => { if (document.fullscreenElement) return 1; },  
 37710: () => { return document.getElementById('canvas').width; },  
 37762: () => { return screen.width; },  
 37787: () => { return window.innerWidth; },  
 37813: () => { return window.innerHeight; },  
 37840: () => { if (document.fullscreenElement) return 1; },  
 37886: () => { return document.getElementById('canvas').width; },  
 37938: () => { return screen.width; },  
 37963: () => { document.exitFullscreen(); },  
 37990: () => { if (document.fullscreenElement) return 1; },  
 38036: () => { return document.getElementById('canvas').width; },  
 38088: () => { return parseInt(document.getElementById('canvas').style.width); },  
 38156: () => { document.exitFullscreen(); },  
 38183: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 38241: () => { return screen.width; },  
 38266: () => { return screen.height; },  
 38292: () => { return window.screenX; },  
 38319: () => { return window.screenY; },  
 38346: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 38399: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 38470: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 38527: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 38783: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 38854: () => { if (document.fullscreenElement) return 1; },  
 38900: () => { return window.innerWidth; },  
 38926: () => { return window.innerHeight; },  
 38953: () => { if (document.pointerLockElement) return 1; }
};
